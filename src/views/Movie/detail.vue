...
<style scoped>
#detailPage{width:100%;min-height:100%;position: absolute;top:0;left:0;z-index: 10;background-color: #fff;}
#detailPage.slide-enter-active{animation:.3s slideMove;}
@keyframes slideMove {
